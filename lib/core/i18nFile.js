...
var VueI18n = /** @class */ (function () {
    ...
    VueI18n.prototype.getHashMessage = function () {
    ...
    VueI18n.prototype.initIndex = function () {
        ...
        this.index = Math.max.apply(Math, __spreadArray([0], Object.keys(this.messages).map(function (item) { return Number(item.replace(/^[^\d]+/, '') || 0) || 0; }), false));
        this.index++;
    };
    /**
     * 合并配置
     ...
     * 删除所有数据
    */
    VueI18n.prototype.deleteMessages = function () {
        this.messagesHash = {};
        this.messages = {};
        this.index = 1;
    };
