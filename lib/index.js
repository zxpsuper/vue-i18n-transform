...
function generateVueFile(file) {
    ...
    content = (0, utils_1.replaceVueTemplate)({
        ...
        replaceFail: function (_a) {
            var currentKey = _a.currentKey;
            i18nFile_1.VueI18nInstance.deleteMessageKey(currentKey);
        }
    });
    // 替换script中的部分
...
function generate() {
    ...
    if (fs.existsSync(configPath)) {
        ...
        if (typeof config === 'object' && config.toString() === '[object Object]') {
            i18nFile_1.VueI18nInstance.mergeConfig(config);
